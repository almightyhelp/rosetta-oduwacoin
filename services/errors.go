...
var (
	...
	// ErrNotReady is returned when oduwacoind is not
	// yet ready to serve queries.
	ErrNotReady = &types.Error{
		Code:      2, //nolint
		Message:   "Oduwacoind is not ready",
		Retriable: true,
	}

	// ErrOduwacoind is returned when oduwacoind
	// errors on a request.
	ErrOduwacoind = &types.Error{
		Code:    3, //nolint
		Message: "Oduwacoind error",
	}
	...
	// oduwacoin.ScriptPubKeys to construct a transaction.
	...
	// oduwacoin.ScriptPubKey cannot be parsed during construction.
