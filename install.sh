...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for coinbase/rosetta-oduwacoin 
...
execute() {
  ...
  docker tag "rosetta-oduwacoin:${TAG}" "rosetta-oduwacoin:latest"
  log_info "loaded rosetta-oduwacoin:${TAG} and tagged as rosetta-oduwacoin:latest"
  rm -rf "${tmpdir}"
...
BINARY=rosetta-oduwacoin
FORMAT=tar.gz
OWNER=coinbase
REPO="rosetta-oduwacoin"
PREFIX="$OWNER/$REPO"
